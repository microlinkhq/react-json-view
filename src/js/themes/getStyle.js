...
const colorMap = theme => ({
  ...
  expandedIcon: theme.base0F,
  collapsedIcon: theme.base0E,
  keyColor: theme.base07,
  arrayKeyColor: theme.base0F,
  objectSize: theme.base0B,
  copyToClipboard: theme.base0C,
  copyToClipboardCheck: theme.base0A,
  objectBorder: theme.base02,
  dataTypes: {
    boolean: theme.base0F,
    date: theme.base0F,
    float: theme.base0F,
    function: theme.base0F,
    integer: theme.base0F,
    string: theme.base0F,
    nan: theme.base0F,
    null: theme.base0F,
    undefined: theme.base0F,
    regexp: theme.base0F,
    background: theme.base0F
  },
  editVariable: {
    editIcon: theme.base0B,
    cancelIcon: theme.base09,
    removeIcon: theme.base09,
    customEventIcon: theme.base08,
    addIcon: theme.base0D,
    checkIcon: theme.base0A,
...
const getDefaultThemeStyling = theme => {
  ...
  return {
    ...
    customEventIcon: {
      verticalAlign: 'top',
      display: 'inline-block',
      color: colors.editVariable.customEventIcon,
      cursor: constants.iconCursor,
      fontSize: constants.iconFontSize,
      marginRight: constants.iconMarginRight
    },
